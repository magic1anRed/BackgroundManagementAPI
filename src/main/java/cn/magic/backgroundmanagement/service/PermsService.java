...
public class PermsService {
    ...
    public R list(String name,Integer status) {
        EntityQueryable<PermsEntityProxy, PermsEntity> queryable = easyEntityQuery.queryable(PermsEntity.class);
        if (name != null && !name.isEmpty()){
            queryable.where(p -> p.name().like(name));
        }
